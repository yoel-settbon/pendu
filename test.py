                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if letter.isalpha() and len(letter) == 1:
                        if letter in guessed_letters:
                            draw_text("You already guessed that letter!", font, RED, WINDOW_WIDTH // 2, 350)
                        else:
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if letter.isalpha() and len(letter) == 1:
                        if letter in use_letter:
                            draw_text("You already guessed that letter!")
                        else:
...
def main_menu():
    ...
    draw_text("2. Exit", font, WHITE, WINDOW_WIDTH // 2, 415)
